        ...
        <div className="flex m-auto w-2/3 justify-between items-start 0 -mt-11">
          <div className="bg-white w-[70%] rounded p-3 shadow">
            ...
            <nav className="flex text-reg border-b pb-2">
              <Link href="/restaurant/tuti-santi" className="mr-7">
                Overview
              </Link>
              <Link href="/restaurant/tuti-santi/menu" className="mr-7">
                Menu
              </Link>
            </nav>
            {/* RESAURANT NAVBAR */} {/* TITLE */}
            <div className="mt-4 border-b pb-6">
              <h1 className="font-bold text-6xl">Tuti-Santi</h1>
            </div>
            {/* TITLE */} {/* RATING */}
            ...
            <div className="mt-4">
              <p className="text-lg font-light">
                ...
                up in an atmosphere that feels just right. That’s the Tuti-Santi
                promise. So, whether you’re celebrating a Tuti-Santi, making the
                most of Happy Hour or enjoying brunch with friends, you can be
                sure that every Tuti-Santi experience is a simple and perfectly
                memorable one.
              </p>
            </div>
            {/* DESCRIPTION */} {/* IMAGES */}
